...
using CapShop.ReviewService.Application.Services;
using CapShop.ReviewService.Consumers;
using CapShop.ReviewService.Data;
using CapShop.ReviewService.Infrastructure.Repositories;
using CapShop.ReviewService.Middleware;
using MassTransit;
...
builder.Services.AddMassTransit(x =>
{
    ...
    x.AddConsumer<OrderReviewEligibilityCreatedEventConsumer>();
